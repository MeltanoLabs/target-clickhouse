...
def test_http_secure_sets_protocol_and_verify_query_params() -> None:
    ...
    assert parsed.query["verify"] == "True"
...
def test_native_driver_sets_secure_and_verify_query_params() -> None:
    config = {
        **CONFIG,
        "driver": "native",
        "port": 19000,
